...
import org.seedstack.samples.ddd.domain.model.handling.UnknownLocationException;
...
public interface BookingService {
     ...
     */
    TrackingId bookNewCargo(UnLocode origin, UnLocode destination, Date arrivalDeadline) throws UnknownLocationException;
     ...
     */
    void changeDestination(TrackingId trackingId, UnLocode unLocode) throws UnknownLocationException;
